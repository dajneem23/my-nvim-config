    ...
    config = function()
        ...
        require("neo-tree").setup({
            ...
            filesystem = {
                ...
                use_libuv_file_watcher = true, -- required for live-updates,This will use the OS level file watchers to detect changes -- instead of relying on nvim autocmd events.
                bind_to_cwd = false, -- <== this prevents auto-changing cwd
                cwd_target = {
                    sidebar = "none", -- keep the previous root in the sidebar
                    current = "none" -- don't change cwd with the current buffer
                },
                window = {
                    mappings = {
                        ["<bs>"] = "navigate_up",
                        ...
                        --     end
                        -- end
                        ["<tab>"] = "toggle_node" -- check this is valid
        ...
        vim.keymap.set("n", "<leader>e", function()
            require("neo-tree.command").execute({
                toggle = true,
                source = "filesystem",
                dir = vim.loop.cwd() -- Use stored root instead of default cwd
            })
        end, {
            desc = "Toggle NeoTree with last root"
        })
        vim.keymap.set("n", "<leader><Tab>", function()
            ...
            desc = "Toggle focus between Neo-tree and editor"
        })
